 ...
 * </p>
 * <ul>
 *   <li>{@link airport.areas.impl.DepartureImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link airport.areas.impl.DepartureImpl#getCheckIn <em>Check In</em>}</li>
 *   <li>{@link airport.areas.impl.DepartureImpl#getBaggageDropOff <em>Baggage Drop Off</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartureImpl extends AreaImpl implements Departure {
	...
	protected EClass eStaticClass() {
		return AreasPackage.Literals.DEPARTURE;
	}
	...
	public EList<SecurityCheck> getSecurity() {
		if (security == null) {
			security = new EObjectContainmentEList<SecurityCheck>(SecurityCheck.class, this, AreasPackage.DEPARTURE__SECURITY);
		}
		return security;
	}
	...
	public EList<CheckIn> getCheckIn() {
		if (checkIn == null) {
			checkIn = new EObjectContainmentEList<CheckIn>(CheckIn.class, this, AreasPackage.DEPARTURE__CHECK_IN);
		}
		return checkIn;
	}
	...
	public EList<BaggageDropOff> getBaggageDropOff() {
		if (baggageDropOff == null) {
			baggageDropOff = new EObjectContainmentEList<BaggageDropOff>(BaggageDropOff.class, this, AreasPackage.DEPARTURE__BAGGAGE_DROP_OFF);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AreasPackage.DEPARTURE__SECURITY:
				return ((InternalEList<?>)getSecurity()).basicRemove(otherEnd, msgs);
			case AreasPackage.DEPARTURE__CHECK_IN:
				return ((InternalEList<?>)getCheckIn()).basicRemove(otherEnd, msgs);
			case AreasPackage.DEPARTURE__BAGGAGE_DROP_OFF:
