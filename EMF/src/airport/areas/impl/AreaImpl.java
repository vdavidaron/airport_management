 ...
 * </p>
 * <ul>
 *   <li>{@link airport.areas.impl.AreaImpl#getAreaCorners <em>Area Corners</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AreaImpl extends MinimalEObjectImpl.Container implements Area {
	...
	protected EClass eStaticClass() {
		return AreasPackage.Literals.AREA;
	}
	...
	public EList<Point> getAreaCorners() {
		if (areaCorners == null) {
			areaCorners = new EObjectContainmentEList<Point>(Point.class, this, AreasPackage.AREA__AREA_CORNERS);
		}
		return areaCorners;
	}
